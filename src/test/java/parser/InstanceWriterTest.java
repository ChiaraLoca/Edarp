...
class InstanceWriterTest {
    ...
    void write() throws FileNotFoundException, ParseException {
        ...
        Instance instanceA = instanceReader.read(new File("src/main/resources/instances/a2-16-0.7.txt"),true);

        InstanceWriter instanceWriter = new InstanceWriter(instanceA, "Ampl");
        instanceWriter.write();

        Instance instanceU = instanceReader.read(new File("src/main/resources/instances/u2-16-0.7.txt"),true);
